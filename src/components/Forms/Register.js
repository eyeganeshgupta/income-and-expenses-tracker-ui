          ...
          <div className="max-w-xl mx-auto py-10 px-8 sm:px-20 bg-white rounded-md">
            <div className="mb-6">
              ...
              {userAuth?.error?.message && (
                <h2 className="text-red-800 text-center mt-2">
                  {userAuth?.error?.message}
                </h2>
              )}
            </div>
            <form onSubmit={onSubmitHandler}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="block w-full p-4 font-heading text-gray-600 placeholder-gray-300 bg-gray-50 rounded outline-none"
                  type="text"
              ...
              <div className="text-right mb-6">
                {loading ? (
                  <button className="block w-full py-4 px-6 text-center font-heading font-medium text-base text-white bg-gray-500 hover:bg-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200">
                    Loading
                  </button>
                ) : (
                  <button
