          ...
          <div className="max-w-xl mx-auto py-10 px-8 sm:px-20 bg-white rounded-md">
            ...
            <form onSubmit={onSubmitHandler}>
              ...
              <div className="text-right mb-6">
                {loading ? (
                  <button className="block w-full py-4 px-6 text-center font-heading font-medium text-base text-white bg-gray-500 hover:bg-green-400 border border-green-500 hover:border-green-600 rounded-sm transition duration-200">
                    Loading...
                  </button>
                ) : (
                  <button
